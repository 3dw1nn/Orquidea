        ...
        <div class="dropdown ml-3">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                ...
                <a class="dropdown-item" href="#" id="create-backup-only-files" wire:click.prevent="">
                    Crear copia de seguridad Archivos
                </a>
            </div>
        </div>
    </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <span class="text-muted">
                                    ¿Está seguro de que desea eliminar la copia de seguridad?{{ $deletingFile['date'] }} ?
                                </span>
                                @endif
                            </div>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            const backupFun = function (option = '') {
                Toastify({
                    text: 'Creando una nueva copia de seguridad...' + (option ? ' (' + option + ')' : ''),
                    duration: 5000,
                    gravity: 'bottom',
                    position: 'right',
            ...
            $('#create-backup-only-db').on('click', function () {
                backupFun('Solo Base de datos')
            })
            $('#create-backup-only-files').on('click', function () {
                backupFun('Solo Archivos')
            })
